...
#Number of pieces to divide the image into
int SLICE_NUMBER = 4;

#Divides the image into numper of pieces declared
image_slicer.slice('map.png',SLICE_NUMBER)

int i = 0
while i < SLICE_NUMBER:
    IMAGEPATH[i]='C:\Users\Rushit\source\repos\ec-autonav\src\map_01_01'
